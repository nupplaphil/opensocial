...
const oauth2TokenRepository = createTokenRepository(knex, oauth2ClientRepository, userRepository);
const oauth2CodeRepository = createCodeRepository(knex, oauth2ClientRepository, userRepository);
